...
//Used OpenTriMap API cause the Google API required a billing account
class OpenTriMapsCalls {
  ...
  Future fetchData({required String state, String kindsFilter = ""}) async {
    double lat = 30.0444; // Default to Cairo
    double lon = 31.2357; // Default to Cairo
    ...
    switch (state) {
      ...
      case "Luxor":
        ...
        break;
      default:
        // Default to Cairo if state is not recognized
        lon = 31.2357;
        lat = 30.0444;
        break;
    }
